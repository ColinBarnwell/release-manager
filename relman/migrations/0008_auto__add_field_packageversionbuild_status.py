...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersionBuild.status'
        db.add_column(u'relman_packageversionbuild', 'status',
                      self.gf('django.db.models.fields.CharField')(default='in_progress', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageVersionBuild.status'
        db.delete_column(u'relman_packageversionbuild', 'status')
