...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BenchmarkCheck.notes'
        db.delete_column(u'relman_benchmarkcheck', 'notes')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'BenchmarkCheck.notes'
        db.add_column(u'relman_benchmarkcheck', 'notes',
    ...
    models = {
        ...
        'relman.benchmarkcheck': {
            'Meta': {'unique_together': "(('build', 'benchmark'),)", 'object_name': 'BenchmarkCheck'},
