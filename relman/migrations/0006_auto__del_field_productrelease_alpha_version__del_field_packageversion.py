...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductRelease.alpha_version'
        db.delete_column(u'relman_productrelease', 'alpha_version')

        # Deleting field 'PackageVersion.previous_version'
        db.delete_column(u'relman_packageversion', 'previous_version_id')

        # Deleting field 'PackageVersion.alpha_version'
        db.delete_column(u'relman_packageversion', 'alpha_version')


    def backwards(self, orm):
        # Adding field 'ProductRelease.alpha_version'
        db.add_column(u'relman_productrelease', 'alpha_version',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'PackageVersion.previous_version'
        db.add_column(u'relman_packageversion', 'previous_version',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relman.PackageVersion'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackageVersion.alpha_version'
        db.add_column(u'relman_packageversion', 'alpha_version',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)
